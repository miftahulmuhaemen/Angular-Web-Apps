...
@Component({
  selector: 'app-edit-profil-dinas',
  templateUrl: './edit-profil-dinas.component.html',
  styleUrls: ['./edit-profil-dinas.component.css']
})
export class EditProfilDinasComponent implements OnInit {
  ...
  constructor(public registerService:RegisterService, private fb: FormBuilder,
        private dialogRef: MatDialogRef<EditProfilDinasComponent>,
